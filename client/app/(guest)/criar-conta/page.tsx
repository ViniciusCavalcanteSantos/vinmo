...
import {register} from "@/app/lib/database/User";
...
export default function Page() {
  ...
  return (
    ...
    >
      {contextHolder}
      <h1 className="text-center mb-8 text-2xl font-semibold">Criar Conta</h1>
      ...
      <Form.Item>
        ...
        ou <Link href="/criar-conta">Fazer login!</Link>
      </Form.Item>
    </Form>
  );
}
